...
public class MultiPartFileSender {
    ...
    public MultiPartFileSender(FileDescriptor fileDescriptor, FileLoader loader){
    ...
    public void serveResource() throws Exception {
        ...
        Long length = fileDescriptor.getSize();
        String fileName = fileDescriptor.getName();
        FileTime lastModifiedObj = FileTime.from(Instant.from(fileDescriptor.getUpdateTs().toInstant()));
        ...
        // Prepare streams.
        try (InputStream input = new BufferedInputStream(loader.openStream(fileDescriptor));
